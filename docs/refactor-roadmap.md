...
OqlOS: 99 surowych wyjątków (baseline 137), 0 literalnych negatywnych envelope
przy HTTP 200.
...
Pozostały zakres: sklasyfikować 99 surowych wyjątków i 235 szerokich handlerów
