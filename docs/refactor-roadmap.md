...
OqlOS: 108 surowych wyjątków (baseline 137), 0 literalnych negatywnych envelope
przy HTTP 200.
...
Pozostały zakres: sklasyfikować 108 surowych wyjątków i 241 szerokich handlerów
