...
Bieżący stan wykonawczy po ósmej grupie `NEXT-04`: commit `7034c27`, 194
...
Audyt wskazuje 183 szerokie handlery i 81 surowych wyjątków; bramka: 1089/1089
backend, 149/149 frontend, build Vite, Ruff i `uv lock --check`.
