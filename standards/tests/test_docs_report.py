...
class DocumentationCompletion(unittest.TestCase):
    def setUp(self):
        ...
        self.git("remote", "add", "origin", "https://github.com/oqlos/oqlos.git")
        ...
        metadata = dict(
            ...
            affected_repositories=["oqlos/oqlos"],
    ...
    def test_authenticated_mirror_identity_is_read_only(self):
        ...
        os.environ.update(ONEDEV_PR_REPOSITORY="oqlos/oqlos", ONEDEV_PR_MAIN_SHA=self.base)
