...
_CODE_SOURCE_PATHS = [
    *sorted(_DOCTOR_DIR.glob("doctor_*.py")),
    ...
    _REPO_ROOT / "oqlos" / "api" / "execution.py",
    ...
    _REPO_ROOT / "oqlos" / "api" / "hardware_modbus_wizard_boundary.py",
    ...
    _REPO_ROOT / "oqlos" / "api" / "state.py",
    _REPO_ROOT / "oqlos" / "api" / "ui_prefs_routes.py",
    _REPO_ROOT / "oqlos" / "api" / "utils" / "execution_ctrl.py",
