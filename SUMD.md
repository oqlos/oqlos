...
- **generated_from**: pyproject.toml, Taskfile.yml, testql(6), openapi(49 ep), app.doql.less, pyqual.yaml, goal.yaml, .env.example, Dockerfile, docker-compose.dev.yml, src(1 mod), project/(1 analysis files)
...
M[128]:
  ...
  oqlos/api/hardware.py,282
  oqlos/api/logs.py,46
  oqlos/api/main.py,170
  oqlos/api/peripherals.py,71
  oqlos/api/plugins.py,138
  ...
  oqlos/core/_cql_tokenizer.py,387
  ...
  oqlos/hardware/__init__.py,1
  oqlos/hardware/config_schema.py,126
  ...
  oqlos/hardware/firmware_adapter.py,429
  oqlos/hardware/gateway.py,416
  oqlos/hardware/peripheral_mapping.py,139
  oqlos/hardware/plugin_gateway.py,349
  oqlos/hardware/plugins/__init__.py,44
  oqlos/hardware/plugins/_shared.py,62
  oqlos/hardware/plugins/base.py,327
  oqlos/hardware/plugins/lung.py,246
  oqlos/hardware/plugins/modbus.py,259
  oqlos/hardware/plugins/motor.py,377
  oqlos/hardware/plugins/piadc.py,151
  oqlos/hardware/plugins/registry.py,317
  ...
  oqlos/tools/cql_cli/main.py,196
  oqlos/tools/cql_cli/preflight.py,266
  oqlos/tools/cql_cli/utils.py,149
  oqlos/tools/cql_cli.py,58
  oqlos/tools/hardware_diagnose/__init__.py,54
  oqlos/tools/hardware_diagnose/__main__.py,136
  oqlos/tools/hardware_diagnose/benchmark.py,56
  oqlos/tools/hardware_diagnose/calibration.py,93
  oqlos/tools/hardware_diagnose/discovery.py,113
  oqlos/tools/hardware_diagnose/health.py,81
  oqlos/tools/hardware_diagnose/report.py,64
  oqlos/tools/hardware_diagnose/shell.py,139
  oqlos/tools/hardware_diagnose.py,37
  oqlos/tools/plugin_cli.py,343
  ...
  tests/firmware/test_hardware_identify.py,88
  ...
  tests/test_core.py,488
  tests/test_cql_cli.py,166
  ...
  tests/test_oql_parser_v3.py,348
...
D:
  ...
  oqlos/hardware/plugins/lung.py:
    e: LungPlugin
    LungPlugin: __init__(1),validate_config(0),connect(0),disconnect(0),health_check(0),_handle_reciprocate_http(1),_handle_reciprocate_usb(1),_handle_stop_http(0),_handle_stop_usb(0),_handle_move_http(1),_handle_move_usb(1),_handle_energize_http(1),_handle_energize_usb(1),_handle_status_http(0),_handle_status_usb(0),execute_command(2),get_capabilities(1)  # Plugin for Pololu Tic T249 stepper motor (artificial lung).
  oqlos/hardware/plugins/modbus.py:
    e: ModbusPlugin
    ModbusPlugin: __init__(1),validate_config(0),connect(0),disconnect(0),health_check(0),execute_command(2),get_capabilities(1)  # Plugin for Waveshare Modbus RTU IO 8CH valve controller.
  oqlos/hardware/plugins/motor.py:
    e: MotorPlugin
    MotorPlugin: __init__(1),validate_config(0),connect(0),disconnect(0),health_check(0),_validate_power_pct(1),_handle_set_speed_http(2),_handle_set_speed_cli(2),_handle_set_speed_modbus(2),_handle_stop_http(1),_handle_stop_cli(1),_handle_stop_modbus(1),_handle_status_http(1),_handle_status_cli(1),_handle_status_modbus(1),execute_command(2),get_capabilities(1)  # Plugin for DFRobot DRI0050 PWM motor driver.
  oqlos/hardware/plugins/piadc.py:
    e: PiadcPlugin
    PiadcPlugin: __init__(1),validate_config(0),connect(0),disconnect(0),health_check(0),execute_command(2),get_capabilities(1)  # Plugin for piADC (ADS1115) 16-bit ADC sensor.
  ...
  oqlos/tools/cql_cli/main.py:
    e: create_file_parser,create_cmd_parser,run_file_mode,run_cmd_mode,_dispatch_to_mode,main
    create_file_parser()
    create_cmd_parser()
    run_file_mode(args)
    run_cmd_mode(argv)
  ...
  tests/test_oql_parser_v3.py:
    e: test_tokenize_simple,test_tokenize_brackets_allow_spaces,test_tokenize_double_quoted_string,test_tokenize_single_quoted_string,test_tokenize_unclosed_quote_raises,test_tokenize_unclosed_bracket_raises,test_duration_to_ms,test_parse_minimal_goal,test_parse_metadata,test_parse_check_range,test_parse_check_negative_values,test_parse_sample_with_interval,test_parse_unicode_identifiers,test_parse_bracketed_target_with_spaces,test_parse_bracketed_block_name,test_parse_rejects_unindented_command,test_parse_rejects_unknown_command,test_base_commands_list_matches_dispatcher,test_is_flat_oql_detects_new_syntax,test_is_flat_oql_rejects_legacy,test_adapter_produces_cql_goals,test_adapter_config_prefix,test_macro_call_expansion,test_unknown_macro_becomes_error_action,test_include_resolves_from_scenarios_root,test_include_missing_file_yields_error,test_check_with_correct_message,test_check_with_error_message,test_check_with_both_messages,test_correct_without_check_is_error,test_adapter_uses_custom_messages
