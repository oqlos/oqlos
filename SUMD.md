...
- **generated_from**: pyproject.toml, Taskfile.yml, testql(6), openapi(49 ep), app.doql.less, pyqual.yaml, goal.yaml, .env.example, Dockerfile, docker-compose.dev.yml, src(1 mod), project/(3 analysis files)
...
# oqlos | 209f 38305L | python:201,shell:6,css:1,less:1 | 2026-06-30
# stats: 1217 func | 184 cls | 209 mod | CC̄=4.4 | critical:112 | cycles:0
# alerts[5]: CC _probe_i2c_ads1115=14; CC exec_action_loop_block=14; CC _safe_resolve=14; CC parse_oql=14; CC _command_error_message=14
# hotspots[5]: _resolve fan=21; build_diagnosis_report fan=19; _build_waveshare_diagnose_report fan=18; hardware_identify fan=18; _handle_start fan=18
# evolution: baseline
...
M[209]:
  ...
  oqlos/api/hardware.py,2253
  oqlos/api/logs.py,46
  oqlos/api/main.py,311
  ...
  oqlos/core/_cql_tokenizer.py,407
  oqlos/core/_cql_tree_builder.py,168
  oqlos/core/_dsl_helpers.py,133
  oqlos/core/_firmware_executor.py,211
  oqlos/core/_func_resolver.py,97
  oqlos/core/_interpreter_actions.py,1256
  oqlos/core/_line_parsers.py,247
  oqlos/core/_oql_adapter.py,467
  ...
  oqlos/core/interpreter.py,677
  oqlos/core/motor2_runtime.py,210
  oqlos/core/oql_parser.py,763
  ...
  oqlos/hardware/client/autorepair.py,138
  oqlos/hardware/client/config.py,89
  oqlos/hardware/client/constants.py,70
  oqlos/hardware/client/errors.py,27
  oqlos/hardware/client/http_helpers.py,27
  oqlos/hardware/client/identify_enrich.py,334
  ...
  oqlos/hardware/client/tic249_extended.py,628
  ...
  oqlos/hardware/diagnosis.py,563
  oqlos/hardware/discovery.py,104
  ...
  oqlos/hardware/firmware_adapter.py,482
  oqlos/hardware/gateway.py,417
  oqlos/hardware/hui_actions.py,248
  oqlos/hardware/identify_enrichment.py,19
  oqlos/hardware/modbus_identify.py,132
  oqlos/hardware/peripheral_mapping.py,139
  oqlos/hardware/plugin_gateway.py,613
  oqlos/hardware/plugins/__init__.py,50
  oqlos/hardware/plugins/_rtu_serial.py,34
  oqlos/hardware/plugins/_shared.py,62
  oqlos/hardware/plugins/base.py,371
  oqlos/hardware/plugins/lung.py,354
  oqlos/hardware/plugins/modbus.py,336
  oqlos/hardware/plugins/modbus_adc.py,399
  oqlos/hardware/plugins/motor.py,550
  ...
  oqlos/hardware/scanner_probe.py,263
  oqlos/hardware/sidecar_control.py,227
  oqlos/hardware/stack_snapshot.py,89
  oqlos/hardware/tic249_units.py,6
  oqlos/hardware/transport/__init__.py,25
  oqlos/hardware/transport/manage_ops.py,185
  oqlos/hardware/transport/mqtt_oql_bridge.py,495
  ...
  oqlos/tools/cql_cli/commands.py,187
  oqlos/tools/cql_cli/formatting.py,64
  oqlos/tools/cql_cli/main.py,413
  oqlos/tools/cql_cli/preflight.py,330
  ...
  oqlos/tools/hardware_diagnose/doctor.py,1004
  oqlos/tools/hardware_diagnose/health.py,118
  oqlos/tools/hardware_diagnose/modbus_probe.py,206
  ...
  tests/firmware/test_hardware_diagnosis_api.py,110
  ...
  tests/firmware/test_oql_envelope.py,61
  tests/firmware/test_oql_manage_ops.py,43
  ...
  tests/firmware/test_plugin_gateway_env.py,203
  ...
  tests/firmware/test_rtc_probe.py,131
  ...
  tests/test_core.py,854
  tests/test_cql_cli.py,406
  ...
  tests/test_oql_parser_v3.py,491
...
D:
  ...
  oqlos/api/editor.py:
    e: _default_scenarios_dir,_safe_path,list_files,read_file_endpoint,write_file_endpoint,execute_scenario,FileInfo,FileContent,ExecutionRequest
    FileInfo:
    FileContent:
    ExecutionRequest:
  ...
  oqlos/api/logs.py:
    ...
    get_log_stats()
  oqlos/api/main.py:
    e: _app_lifespan,_initialize_runtime_dependencies,_start_oql_transport,_stop_oql_transport,index_page,editor_page,panel_page,health_check,status,websocket_endpoint,oql_websocket_alias,_parse_server_args,run
    _app_lifespan(_)
  ...
  oqlos/core/_firmware_executor.py:
    e: FirmwareExecutor
    FirmwareExecutor: __init__(7),_get_firmware(0),resolve_peripheral_id(1),normalize_peripheral_value(2),refresh_sensors_from_firmware(1),execute_firmware_action(2),_execute_plugin_action(2),_execute_legacy_firmware_action(2),exec_set_peripheral(2)  # Executes hardware actions via plugin gateway or legacy firmw
  ...
  oqlos/core/_interpreter_actions.py:
    ...
    _motor2_set_mode(interp;setting;state)
    _motor2_set_limit_mode(interp;setting;state)
    _motor2_set_limit(interp;setting;state)
    _motor2_set_stroke(interp;setting;state)
    _motor2_set_cycle_volume(interp;setting;state)
    _motor2_set_volume(interp;setting;state)
    _motor2_set_duration(interp;setting;state)
    _motor2_set_cycles(interp;setting;state)
  ...
  oqlos/core/_oql_adapter.py:
    e: _fmt_value,_scenarios_root,_resolve_include,_substitute_args,_load_includes,_lower_include,_lower_call,_lower_set,_lower_get,_lower_wait,_lower_save,_lower_min,_lower_max,_lower_check,_lower_if_delta,_lower_sample,_lower_log,_lower_error_cmd,_lower_repeat,_cmd_to_actions,_parse_macro_line,is_flat_oql,oql_doc_to_cql,_split_device_field,parse_flat_oql,_MacroRegistry
    ...
    _lower_min(cmd;macros;visiting)
    _lower_max(cmd;macros;visiting)
  ...
  oqlos/core/oql_parser.py:
    e: to_num,parse_duration,duration_to_ms,_unescape,tokenize,_require,_split_value_unit,_split_set_value_unit,parse_SET,parse_GET,parse_WAIT,parse_IF_DELTA,parse_SAVE,parse_CHECK,parse_IF,parse_MIN,parse_MAX,parse_SAMPLE,parse_LOG,parse_ERROR,parse_CORRECT,parse_CALL,parse_INCLUDE,parse_FUNC_CALL,parse_REPEAT,_line_indent,_expand_repeat_block_lines,_expand_repeat_blocks,_handle_top_level_line,_handle_block_header,_handle_macro_body_line,_handle_set_name,_handle_modifier_cmd,_parse_and_append_command,_validate_oql_version,_check_unnamed_goals,parse_oql,format_doc,OqlCmd,OqlBlock,OqlDoc
  ...
  oqlos/hardware/client/autorepair.py:
    e: _health_map,plugin_needs_repair,modbus_plugins_need_repair,_plugin_repair_reasons,_no_response_reasons,analyze_repair_needs,modbus_exclusive_scan_recommended,overall_stack_healthy,build_summary
    _health_map(identify)
  ...
  oqlos/hardware/client/config.py:
    e: float_from_env,int_from_env,candidate_oqlos_bases,OqlosHardwareProxyConfig
  ...
  oqlos/hardware/client/identify_enrich.py:
    e: _platform_serial_ports,_health_message,_enrich_disabled,_enrich_motor_tic249,_enrich_motor_dri0050,_enrich_modbus_adapter,_enrich_by_device_id,enrich_adapter_entry,_adapter_status_modbus,_adapter_status_tic249,adapter_status_from_health,_parse_csv_ints,_ids_from_preflight,_modbus_io_instance_ids,_expand_modbus_io_instances,count_detected_adapters,enrich_identify_payload,enrich_hardware_identify
    _platform_serial_ports(platform)
    _health_message(health;probe)
    _enrich_disabled(adapter;message)
    _enrich_motor_tic249(adapter;probe;status;lowered;adapter_visible)
    _enrich_motor_dri0050(adapter;probe;status;lowered)
    _enrich_modbus_adapter(adapter;probe;status;lowered;adapter_visible)
    _enrich_by_device_id(hw_id;adapter;probe;status;lowered;adapter_visible)
    enrich_adapter_entry(adapter)
    _adapter_status_modbus(hw_id;status;lowered;probe)
    _adapter_status_tic249(hw_id;status;lowered;probe)
    adapter_status_from_health(hw_id;health_entry)
    _parse_csv_ints(raw)
    _ids_from_preflight(payload)
    _modbus_io_instance_ids(payload)
    _expand_modbus_io_instances(adapters;payload)
  ...
  oqlos/hardware/client/tic249_extended.py:
    e: _arg,_plugin_payload,_execute,_steps_per_second_to_raw,_normalize_motion_params,_stroke_steps,_apply_reciprocate_direction,_build_reciprocate_params,_map_lung_or_reciprocate,_command_mapping,_extract_position,_command_error_message,_generic_failure_hint,_failure,_plugin_unavailable_error,_tic249_sidecar_base_urls,_tic249_sidecar_base_url,_sidecar_reports_deenergized,_attempt_disable_deenergize,_disable_success_response,_sidecar_reciprocate_preferred,_attempt_reciprocate_via_sidecar,_direct_sidecar_deenergize,_lung_disable_fallback,_normalize_target_state,_handle_hardware_proxy_error,_handle_move_relative_command,_try_disable_fallback,_try_sidecar_reciprocate,run_extended_motor_tic249_command
    _arg(args;snake;camel;default)
    _plugin_payload(command;params)
    _execute(proxy;command;params)
    _steps_per_second_to_raw(value;args)
    _normalize_motion_params(args)
    _stroke_steps(args;default)
    _apply_reciprocate_direction(params;args)
    _build_reciprocate_params(args)
    _map_lung_or_reciprocate(command;args)
    _command_mapping(command;args)
    _extract_position(payload)
    _command_error_message(result)
    _generic_failure_hint(result)
    _failure(result)
    _plugin_unavailable_error(exc)
    _tic249_sidecar_base_urls()
    _tic249_sidecar_base_url()
    _sidecar_reports_deenergized()
    _attempt_disable_deenergize(hardware_proxy;command)
    _disable_success_response(command;fallback_result;fallback_name)
    _sidecar_reciprocate_preferred()
    _attempt_reciprocate_via_sidecar(params)
    _direct_sidecar_deenergize(command)
    _lung_disable_fallback(hardware_proxy;command)
    _normalize_target_state(command;result)
  ...
  oqlos/hardware/diagnosis.py:
    e: _health_map,is_stale_hardware_message,is_stale_hardware_entry,plugin_is_healthy,plugin_needs_repair,_report_device_status,modbus_plugins_need_repair,_adapter_index,_message_lower,_infer_status,_action_dict,report_to_dict,_add_modbus_device_actions,_add_tic249_device_actions,_add_dri0050_device_actions,_diagnose_plugin_devices,_build_report_global_actions,_resolve_host_recover,_diagnose_barcode_scanner,_build_stack_snapshot,build_diagnosis_report,_should_include_host_action,_host_actions_from_report,_recover_targets,_repair_dri0050_if_needed,execute_safe_recover,DiagnosisAction,DeviceDiagnosis,DiagnosisReport
    DiagnosisAction:
    DeviceDiagnosis:
    DiagnosisReport:
    _health_map(identify)
    ...
    _message_lower(entry)
    _infer_status(plugin_id;entry)
    _action_dict(action)
    ...
    _diagnose_plugin_devices(health;adapters;platform;topology;host_recover)
    _build_report_global_actions(modbus_bad;motors_bad;c2004_root;host_recover)
    _resolve_host_recover()
    _diagnose_barcode_scanner(adapters)
    ...
    _repair_dri0050_if_needed(targets;health_before;repairs)
    execute_safe_recover(gateway;report)
  oqlos/hardware/discovery.py:
    e: _ensure_local_pimodbus_on_path,probe_waveshare_modbus,probe_waveshare_modbus_adc
    _ensure_local_pimodbus_on_path()
    probe_waveshare_modbus(preferred_port;preferred_baud;preferred_parity;preferred_device_id;timeout)
    probe_waveshare_modbus_adc(preferred_port;preferred_baud;preferred_parity;preferred_device_id;timeout)
  ...
  oqlos/hardware/hui_actions.py:
    e: _success,_operation,_set_valve,_set_pump,_set_pump_best_effort,shutdown_all_hui_hardware,list_hui_actions,start_hui_hold,stop_hui_hold,_run_tic249_reciprocate,start_hui_artificial_lung,stop_hui_artificial_lung
    _success(value)
    _operation(name;ok)
  ...
  oqlos/hardware/plugins/modbus_adc.py:
    ...
    ModbusAdcPlugin: __init__(1),validate_config(0),connect(0),disconnect(0),health_check(0),execute_command(2),_read_registers(0),_format_channels(1),_format_channel(2),_peripheral_for_channel(1),_rtu_timeout(0),_device_id(0),_read_address(0),_read_count(0),get_capabilities(1)  # Plugin for Waveshare Modbus RTU Analog Input 8CH.
  ...
  oqlos/hardware/scanner_probe.py:
    e: _match_blob,_is_likely_scanner_usb_blob,_is_likely_scanner_input,_usb_product_blob,_canonical_match_key,_match_priority,_merge_matches,_scan_lsusb_matches,_scan_input_matches,_scan_diagnostics_usb_matches,resolve_scanner_presence,build_scanner_adapter_entry,enrich_scanner_adapter
    _match_blob(item)
  ...
  oqlos/hardware/sidecar_control.py:
    e: _modbus_serial_candidates,resolve_dri0050_serial,_dri0050_paths,_http_sidecar_listening,_http_sidecar_healthy,_run_cmd,_free_api_port,ensure_dri0050_sidecar
  ...
  oqlos/hardware/transport/manage_ops.py:
    e: run_manage_verb,_resolve,_usb_list,_pi_diagnostics,_usb_reset,_run_diagnostic_command,list_manage_verbs
    run_manage_verb(verb;args)
    _resolve(verb)
    _usb_list(a)
    _pi_diagnostics(a)
    _usb_reset(a)
    _run_diagnostic_command(a)
    list_manage_verbs()
  oqlos/hardware/transport/mqtt_oql_bridge.py:
    e: build_topics,_make_client,Topics,OqlRequest,OqlResponse,_PahoAsyncClient,OqlMqttController,OqlMqttAgent
    ...
    OqlRequest: to_json(0),from_json(2)  # A request to execute on a remote node.
    OqlResponse: to_json(0),from_json(2)  # The result of executing OQL on a remote node.
  ...
  oqlos/tools/hardware_diagnose/doctor.py:
    e: _usb_serial_only,_load_config_summary,_probe_modbus,_probe_modbus_adc,_serial_port_owners,_canonical_device_path,_owners_for_configured_port,_extract_pids,_describe_pid,detect_hardware,_firmware_hostname,_add_issue,_modbus_config,_modbus_adc_config,_expected_modbus_params,_expected_modbus_adc_params,_analyze_modbus_adc_config,_firmware_modbus_adc_health_ok,_analyze_modbus_config,_check_firmware_health_error,_check_firmware_mode,_check_firmware_serial_access,_check_firmware_adapters,_analyze_firmware_access,_adapter_health_status,_health_status_is_ok,_analyze_serial_port_owners,_collect_repairs,build_doctor_report,apply_safe_fixes,_update_modbus_config,_update_modbus_adc_config,_format_modbus_status,format_detection,_firmware_modbus_health_ok,_firmware_is_remote,_firmware_adapter_status,_format_doctor_issues,_format_doctor_applied_repairs,_format_doctor_unapplied,format_doctor
    _usb_serial_only(devices)
    _load_config_summary(config_path)
    _probe_modbus(probe_timeout)
    _probe_modbus_adc(probe_timeout)
    ...
    _modbus_adc_config(config)
    _expected_modbus_params(modbus_probe)
    _expected_modbus_adc_params(modbus_adc_probe)
    _analyze_modbus_adc_config(detection;issues)
    _firmware_modbus_adc_health_ok(detection)
    _analyze_modbus_config(detection;issues)
    _check_firmware_health_error(firmware;issues)
    ...
    _update_modbus_adc_config(config_path;detected)
    _format_modbus_status(detection)
  ...
  scripts/migrate_to_v4.py:
    e: _quote_oql,find_oql_files,has_version_header,extract_version,_migrate_version_header,_migrate_goal_line,_migrate_loop_line,_migrate_endloop_line,_migrate_set_line,_migrate_wait_line,_migrate_minmax_line,_migrate_save_line,_migrate_single_line,migrate_content,_scan_files,_perform_migration,_perform_dry_run,main,check_database
    _quote_oql(value)
  ...
  tests/firmware/test_hui_actions.py:
    e: run,test_hui_hold_profile_runs_inside_oqlos,test_hui_artificial_lung_uses_tic249_plugin_recipe,test_hui_shutdown_turns_off_pump_and_all_known_valves,FakeGateway,FakeTic249Plugin
  ...
  tests/firmware/test_oql_envelope.py:
    e: test_request_json_roundtrip,test_response_json_roundtrip,test_topics_layout,test_build_result_payload_is_json_serializable
  ...
  tests/firmware/test_oql_manage_ops.py:
    e: test_unknown_verb_raises,test_diagnostic_command_routes_to_plugin_execute,test_diagnostic_command_requires_peripheral_id,test_diagnostic_command_listed
  ...
  tests/firmware/test_oql_route_http.py:
    e: client,test_execute_returns_503_when_transport_disabled,test_execute_dispatches_to_controller,test_execute_surfaces_remote_error_as_ok_false,test_manage_returns_503_when_transport_disabled,test_manage_dispatches_verb_and_args,test_manage_surfaces_remote_error,_FakeController
...
% ── Project Metadata ─────────────────────────────────────
project_metadata('oqlos', '0.1.27', 'python').

% ── Project Files ────────────────────────────────────────
project_file('app.doql.css', 165, 'css').
project_file('app.doql.less', 240, 'less').
...
project_file('oqlos/core/_interpreter_actions.py', 1256, 'python').
...
project_file('oqlos/core/parser.py', 184, 'python').
...
project_file('oqlos/hardware/client/identify_enrich.py', 334, 'python').
...
project_file('oqlos/hardware/client/tic249_extended.py', 628, 'python').
...
project_file('oqlos/hardware/plugin_gateway.py', 613, 'python').
...
project_file('oqlos/hardware/transport/manage_ops.py', 185, 'python').
...
project_file('oqlos/shared/file_ops.py', 109, 'python').
...
project_file('tests/firmware/test_dsl_parser_runtime.py', 144, 'python').
...
project_file('tests/firmware/test_hardware_identify.py', 195, 'python').
...
project_file('tests/firmware/test_oql_manage_ops.py', 43, 'python').
...
project_file('tests/firmware/test_plugin_gateway_env.py', 203, 'python').
...
project_file('tests/firmware/test_rtc_probe.py', 131, 'python').
...
python_function('oqlos/api/editor.py', 'execute_scenario', 1, 5, 11).
...
python_function('oqlos/api/execution.py', 'get_execution', 1, 2, 2).
...
python_function('oqlos/api/hardware.py', '_read_text_file', 1, 2, 3).
python_function('oqlos/api/hardware.py', '_board_model', 0, 1, 4).
python_function('oqlos/api/hardware.py', '_is_raspberry_pi_host', 0, 1, 2).
python_function('oqlos/api/hardware.py', '_os_release', 0, 3, 5).
python_function('oqlos/api/hardware.py', '_in_container', 0, 3, 4).
python_function('oqlos/api/hardware.py', '_selected_hardware_platform', 0, 5, 5).
python_function('oqlos/api/hardware.py', '_selected_piadc_platform', 0, 3, 6).
python_function('oqlos/api/hardware.py', '_classify_platform_type', 4, 9, 0).
python_function('oqlos/api/hardware.py', '_detect_runtime_platform', 0, 7, 16).
python_function('oqlos/api/hardware.py', '_local_ads1115_probe_allowed', 0, 4, 4).
python_function('oqlos/api/hardware.py', '_scan_usb_devices', 0, 9, 7).
...
python_function('oqlos/api/hardware.py', '_modbus_topology_mode', 0, 5, 3).
python_function('oqlos/api/hardware.py', '_apply_modbus_topology', 4, 11, 0).
python_function('oqlos/api/hardware.py', '_modbus_runtime_serial_ports', 0, 12, 5).
python_function('oqlos/api/hardware.py', '_diagnose_shared_bus_matrix', 0, 2, 4).
python_function('oqlos/api/hardware.py', '_merge_unique_text_list', 2, 5, 2).
python_function('oqlos/api/hardware.py', '_merge_waveshare_scan_dicts', 0, 11, 9).
python_function('oqlos/api/hardware.py', '_read_output_control_modes', 5, 8, 10).
python_function('oqlos/api/hardware.py', '_modbus_plugins_healthy', 1, 3, 3).
python_function('oqlos/api/hardware.py', '_modbus_health_serial_stale', 1, 7, 4).
python_function('oqlos/api/hardware.py', '_build_waveshare_serial_stale_report', 1, 8, 2).
...
python_function('oqlos/api/hardware.py', '_resolve_waveshare_ports', 1, 3, 1).
python_function('oqlos/api/hardware.py', '_split_hits_by_role', 1, 5, 1).
python_function('oqlos/api/hardware.py', '_build_waveshare_diagnose_report', 1, 9, 18).
...
python_function('oqlos/api/hardware.py', '_map_adapter_identify_status', 3, 10, 4).
...
python_function('oqlos/api/hardware.py', 'read_sensors_batch', 1, 11, 11).
python_function('oqlos/api/hardware.py', 'hardware_diagnose', 0, 7, 6).
python_function('oqlos/api/hardware.py', 'hardware_modbus_waveshare_diagnose', 0, 1, 4).
python_function('oqlos/api/hardware.py', 'hardware_stack_snapshot', 0, 1, 4).
python_function('oqlos/api/hardware.py', 'hardware_diagnosis_route', 1, 1, 5).
python_function('oqlos/api/hardware.py', 'hardware_recover_route', 1, 2, 10).
python_function('oqlos/api/hardware.py', 'hardware_modbus_wizard_plan', 0, 1, 2).
python_function('oqlos/api/hardware.py', 'hardware_modbus_wizard_probe_isolated', 5, 8, 6).
...
python_function('oqlos/api/peripherals.py', 'get_peripheral', 1, 2, 2).
...
python_function('oqlos/core/_cql_tokenizer.py', '_try_arrow_action', 2, 2, 4).
python_function('oqlos/core/_cql_tokenizer.py', '_try_task', 2, 2, 4).
...
python_function('oqlos/core/_cql_tokenizer.py', '_try_if_fail_block', 2, 2, 4).
...
python_function('oqlos/core/_cql_tokenizer.py', '_try_var', 2, 2, 3).
python_function('oqlos/core/_cql_tokenizer.py', '_try_func', 2, 2, 3).
python_function('oqlos/core/_cql_tokenizer.py', '_try_sample', 2, 3, 3).
python_function('oqlos/core/_cql_tokenizer.py', '_try_api', 2, 2, 3).
python_function('oqlos/core/_cql_tokenizer.py', '_try_goto', 2, 2, 4).
python_function('oqlos/core/_cql_tokenizer.py', '_try_save_ws', 2, 2, 4).
...
python_function('oqlos/core/_interpreter_actions.py', '_normalize_motor2_target', 1, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_direction', 1, 6, 4).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_speed_steps', 1, 5, 9).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_float', 1, 4, 6).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_duration_seconds', 1, 8, 5).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_volume_liters', 1, 6, 5).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_acceleration', 1, 6, 9).
python_function('oqlos/core/_interpreter_actions.py', '_normalize_motor2_value', 1, 2, 4).
python_function('oqlos/core/_interpreter_actions.py', '_parse_prefixed_motor2_setting', 1, 13, 5).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_reciprocating_setting', 1, 6, 5).
python_function('oqlos/core/_interpreter_actions.py', '_parse_motor2_steps', 1, 3, 9).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_speed_raw', 1, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_max_steps_per_second', 0, 1, 1).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_effective_steps_per_second', 1, 1, 4).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_speed_for_duration', 3, 1, 1).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_acceleration_raw', 2, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_post_motor2_move_relative', 4, 6, 11).
python_function('oqlos/core/_interpreter_actions.py', '_post_motor2_reciprocate', 7, 7, 10).
python_function('oqlos/core/_interpreter_actions.py', '_post_motor2_stop', 0, 4, 10).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_reciprocating_state', 1, 2, 3).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_mode', 3, 1, 1).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_limit_mode', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_limit', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_stroke', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_cycle_volume', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_volume', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_duration', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_set_cycles', 3, 1, 2).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_do_stop', 3, 4, 3).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_build_plan', 3, 12, 6).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_step_label', 2, 4, 1).
python_function('oqlos/core/_interpreter_actions.py', '_motor2_do_start', 3, 4, 10).
python_function('oqlos/core/_interpreter_actions.py', '_handle_motor2_reciprocating_setting', 2, 2, 3).
python_function('oqlos/core/_interpreter_actions.py', '_try_exec_motor2_set', 3, 13, 17).
...
python_function('oqlos/core/_line_parsers.py', '_parse_set_line', 2, 12, 14).
...
python_function('oqlos/core/_oql_adapter.py', '_lower_set', 3, 1, 3).
...
python_function('oqlos/core/_oql_adapter.py', '_lower_min', 3, 1, 3).
python_function('oqlos/core/_oql_adapter.py', '_lower_max', 3, 1, 3).
...
python_function('oqlos/core/oql_parser.py', 'parse_MIN', 3, 1, 3).
python_function('oqlos/core/oql_parser.py', 'parse_MAX', 3, 1, 3).
python_function('oqlos/core/oql_parser.py', 'parse_SAMPLE', 3, 3, 6).
python_function('oqlos/core/oql_parser.py', 'parse_LOG', 3, 1, 2).
python_function('oqlos/core/oql_parser.py', 'parse_ERROR', 3, 1, 2).
python_function('oqlos/core/oql_parser.py', 'parse_CORRECT', 3, 1, 2).
python_function('oqlos/core/oql_parser.py', 'parse_CALL', 3, 1, 2).
python_function('oqlos/core/oql_parser.py', 'parse_INCLUDE', 3, 1, 2).
python_function('oqlos/core/oql_parser.py', 'parse_FUNC_CALL', 3, 1, 2).
...
python_function('oqlos/dsl/schema.py', '_merge_object_function_map', 2, 3, 4).
python_function('oqlos/dsl/schema.py', '_merge_param_unit_map', 2, 3, 4).
...
python_function('oqlos/hardware/client/autorepair.py', '_health_map', 1, 4, 2).
...
python_function('oqlos/hardware/client/identify_enrich.py', '_enrich_by_device_id', 6, 4, 3).
python_function('oqlos/hardware/client/identify_enrich.py', 'enrich_adapter_entry', 1, 13, 10).
...
python_function('oqlos/hardware/client/tic249_extended.py', '_build_reciprocate_params', 1, 10, 9).
...
python_function('oqlos/hardware/diagnosis.py', '_health_map', 1, 4, 2).
python_function('oqlos/hardware/diagnosis.py', 'is_stale_hardware_message', 1, 3, 3).
python_function('oqlos/hardware/diagnosis.py', 'is_stale_hardware_entry', 1, 4, 3).
python_function('oqlos/hardware/diagnosis.py', 'plugin_is_healthy', 1, 4, 4).
python_function('oqlos/hardware/diagnosis.py', 'plugin_needs_repair', 2, 9, 6).
python_function('oqlos/hardware/diagnosis.py', '_report_device_status', 2, 2, 2).
python_function('oqlos/hardware/diagnosis.py', 'modbus_plugins_need_repair', 1, 5, 4).
python_function('oqlos/hardware/diagnosis.py', '_adapter_index', 1, 5, 3).
python_function('oqlos/hardware/diagnosis.py', '_message_lower', 1, 4, 3).
python_function('oqlos/hardware/diagnosis.py', '_infer_status', 2, 7, 4).
python_function('oqlos/hardware/diagnosis.py', '_action_dict', 1, 1, 0).
python_function('oqlos/hardware/diagnosis.py', 'report_to_dict', 1, 4, 4).
python_function('oqlos/hardware/diagnosis.py', '_add_modbus_device_actions', 5, 5, 3).
python_function('oqlos/hardware/diagnosis.py', '_add_tic249_device_actions', 4, 3, 4).
...
python_function('oqlos/hardware/plugins/piadc.py', '_read_text_file', 1, 2, 3).
...
python_function('oqlos/hardware/scanner_probe.py', '_match_blob', 1, 3, 4).
...
python_function('oqlos/hardware/scanner_probe.py', '_usb_product_blob', 1, 3, 4).
...
python_function('oqlos/hardware/transport/manage_ops.py', '_resolve', 1, 5, 21).
python_function('oqlos/hardware/transport/manage_ops.py', '_usb_list', 1, 1, 2).
python_function('oqlos/hardware/transport/manage_ops.py', '_pi_diagnostics', 1, 1, 1).
python_function('oqlos/hardware/transport/manage_ops.py', '_usb_reset', 1, 1, 2).
python_function('oqlos/hardware/transport/manage_ops.py', '_run_diagnostic_command', 1, 6, 6).
...
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_extract_pids', 1, 4, 4).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_describe_pid', 1, 4, 4).
...
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_firmware_modbus_adc_health_ok', 1, 4, 3).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_analyze_modbus_config', 2, 11, 7).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_check_firmware_health_error', 2, 3, 2).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_check_firmware_mode', 2, 3, 4).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_check_firmware_serial_access', 4, 11, 5).
...
python_function('oqlos/tools/hardware_diagnose/doctor.py', 'apply_safe_fixes', 2, 9, 6).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_update_modbus_config', 2, 2, 10).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_update_modbus_adc_config', 2, 4, 10).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_format_modbus_status', 1, 7, 4).
python_function('oqlos/tools/hardware_diagnose/doctor.py', 'format_detection', 1, 10, 6).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_firmware_modbus_health_ok', 1, 10, 6).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_firmware_is_remote', 1, 2, 2).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_firmware_adapter_status', 2, 7, 3).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_format_doctor_issues', 1, 5, 5).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_format_doctor_applied_repairs', 1, 4, 2).
python_function('oqlos/tools/hardware_diagnose/doctor.py', '_format_doctor_unapplied', 2, 8, 3).
python_function('oqlos/tools/hardware_diagnose/doctor.py', 'format_doctor', 1, 6, 9).
...
python_function('oqlos/tools/hardware_diagnose/modbus_probe.py', '_env_int', 2, 2, 2).
...
python_function('oqlos/tools/hardware_diagnose/modbus_probe.py', '_env_float', 2, 2, 2).
...
python_function('scripts/migrate_to_v4.py', '_migrate_wait_line', 1, 2, 2).
python_function('scripts/migrate_to_v4.py', '_migrate_minmax_line', 1, 3, 3).
python_function('scripts/migrate_to_v4.py', '_migrate_save_line', 1, 2, 2).
...
python_function('tests/firmware/test_hardware_identify.py', 'test_hardware_identify_reports_modbus_timeout_as_adapter_only', 1, 5, 6).
...
python_function('tests/firmware/test_hardware_modbus_wizard.py', 'test_build_waveshare_diagnose_uses_target_baud_fast_path', 1, 5, 6).
python_function('tests/firmware/test_hardware_modbus_wizard.py', 'test_build_waveshare_diagnose_scans_separate_adapters', 1, 5, 6).
python_function('tests/firmware/test_hardware_modbus_wizard.py', 'test_build_waveshare_skips_matrix_when_plugins_healthy', 1, 6, 6).
python_function('tests/firmware/test_hardware_modbus_wizard.py', 'test_build_waveshare_serial_stale_skips_matrix', 1, 4, 5).
...
python_function('tests/firmware/test_hardware_modbus_wizard.py', 'test_modbus_wizard_plan_exposes_per_adapter_ports', 1, 10, 4).
...
python_class('oqlos/hardware/diagnosis.py', 'DiagnosisAction').
python_class('oqlos/hardware/diagnosis.py', 'DeviceDiagnosis').
python_class('oqlos/hardware/diagnosis.py', 'DiagnosisReport').
...
python_method('_PiAdcAdapter', 'read_channel', 1, 1, 4).
...
python_method('_DRI0050MotorAdapter', 'set_speed', 1, 2, 5).
python_method('_DRI0050MotorAdapter', '_stop', 0, 1, 4).
python_method('_DRI0050MotorAdapter', 'status', 0, 1, 4).
python_class('oqlos/hardware/gateway.py', '_Tic249LungAdapter').
python_method('_Tic249LungAdapter', '__init__', 1, 3, 1).
python_method('_Tic249LungAdapter', 'reciprocate', 4, 1, 4).
python_method('_Tic249LungAdapter', 'stop', 0, 1, 4).
python_method('_Tic249LungAdapter', 'move', 2, 2, 4).
python_method('_Tic249LungAdapter', 'energize', 1, 1, 4).
python_method('_Tic249LungAdapter', 'status', 0, 1, 4).
...
python_method('PluginHardwareGateway', 'health', 0, 7, 3).
...
python_method('LungPlugin', '_handle_reciprocate_http', 1, 5, 5).
python_method('LungPlugin', '_handle_reciprocate_usb', 1, 1, 1).
python_method('LungPlugin', '_handle_stop_http', 0, 2, 2).
python_method('LungPlugin', '_handle_stop_usb', 0, 1, 0).
python_method('LungPlugin', '_handle_move_http', 1, 3, 3).
python_method('LungPlugin', '_handle_move_usb', 1, 1, 1).
python_method('LungPlugin', '_handle_energize_http', 1, 2, 3).
python_method('LungPlugin', '_handle_energize_usb', 1, 1, 1).
python_method('LungPlugin', '_handle_status_http', 0, 2, 2).
...
python_method('ModbusPlugin', '_rtu_timeout', 0, 2, 2).
python_method('ModbusPlugin', '_rtu_call', 1, 2, 5).
python_method('ModbusPlugin', '_device_id', 0, 2, 3).
...
python_method('ModbusAdcPlugin', '_rtu_timeout', 0, 2, 2).
python_method('ModbusAdcPlugin', '_device_id', 0, 2, 3).
python_method('ModbusAdcPlugin', '_read_address', 0, 2, 3).
python_method('ModbusAdcPlugin', '_read_count', 0, 2, 3).
...
python_method('MotorPlugin', '_handle_set_speed_cli', 2, 2, 8).
python_method('MotorPlugin', '_handle_set_speed_modbus', 2, 7, 9).
python_method('MotorPlugin', '_handle_stop_http', 1, 2, 5).
python_method('MotorPlugin', '_handle_stop_cli', 1, 2, 7).
python_method('MotorPlugin', '_handle_stop_modbus', 1, 3, 3).
python_method('MotorPlugin', '_handle_status_http', 1, 2, 4).
python_method('MotorPlugin', '_handle_status_cli', 1, 1, 2).
python_method('MotorPlugin', '_handle_status_modbus', 1, 8, 9).
...
python_method('PiadcPlugin', 'execute_command', 2, 11, 5).
...
*406 nodes · 500 edges · 44 modules · CC̄=4.1*
...
| `build_diagnosis_report` *(in oqlos.hardware.diagnosis)* | 13 ⚠ | 2 | 28 | **30** |
...
# generated in 0.20s
# nodes: 406 | edges: 500 | modules: 44
# CC̄=4.1
...
HUBS[20]:
  ...
  oqlos.core._interpreter_actions._motor2_build_plan
    CC=12  in:1  out:22  total:23
  oqlos.core._interpreter_actions._try_exec_motor2_set
...
MODULES:
  ...
  oqlos.core._interpreter_actions  [56 funcs]
  ...
  oqlos.hardware.diagnosis  [21 funcs]
    _action_dict  CC=1  out:0
    _adapter_index  CC=5  out:5
    _add_modbus_device_actions  CC=5  out:5
    _build_report_global_actions  CC=4  out:6
    _build_stack_snapshot  CC=2  out:1
    _diagnose_barcode_scanner  CC=9  out:9
    _diagnose_plugin_devices  CC=11  out:14
    _health_map  CC=4  out:5
    _host_actions_from_report  CC=7  out:13
    _infer_status  CC=7  out:5
  oqlos.hardware.discovery  [2 funcs]
    probe_waveshare_modbus  CC=5  out:2
    probe_waveshare_modbus_adc  CC=5  out:2
  oqlos.hardware.stack_snapshot  [1 funcs]
  ...
  oqlos.tools.hardware_diagnose.doctor  [40 funcs]
...
EDGES:
  ...
  oqlos.core._interpreter_actions.exec_action_set → oqlos.core._interpreter_actions._try_exec_motor2_set
  oqlos.core._interpreter_actions.exec_action_set → oqlos.core._interpreter_actions._exec_set_wait
  oqlos.core._interpreter_actions.exec_action_set → oqlos.core._interpreter_actions._format_set_command
  oqlos.core._interpreter_actions._parse_motor2_duration_seconds → oqlos.core._interpreter_actions._parse_motor2_float
```
